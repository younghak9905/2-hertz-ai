...
def convert_to_korean(data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    for field in [
        ...
        if field in converted and isinstance(converted[field], list):
            converted[field] = [
                ENUM_MAPPINGS[field].get(item, item) for item in converted[field]
            ]
